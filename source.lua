--[[
Holy shit nigga this is Version 1.0 of the fucking StarBurst script
]]
loadstring(game:HttpGet('https://pastebin.com/raw/AbS3B6fS'))()
wait(5)
...
do
    ...
    do
        ...
        function Library:New(Properties)
            ...
            Logo.Name = "Logo"
            Logo.Image = "http://www.roblox.com/asset/?id=82238774152179"
        ...
        function Library:Watermark(Properties)
            local Watermark = {
                Name = (Properties.Name or Properties.name or "StarBurst | placeholder");
                AnimateText = nil;
            }
            --
            local Outline = Instance.new("Frame")
            ...
            task.spawn(function()
                while task.wait() do
                    for i = 1, #"StarBurst" do
                        Watermark.AnimateText = string.sub("StarBurst", 1, i) .. "";
                        Title.Text = Watermark.AnimateText .. " " .. Watermark.Name;
                        task.wait(0.4);
                    end;

                    for i = #"StarBurst" - 1, 1, -1 do
                        Watermark.AnimateText = string.sub("StarBurst", 1, i) .. "";
                        Title.Text = Watermark.AnimateText .. " " .. Watermark.Name;
                        task.wait(0.4);
                    end;
...
--// window locals
local default_color = Color3.fromRGB(255,105,180);
...
if (not (isfolder("StarBurst"))) then
    makefolder("StarBurst");
end;
...
local locals = {
    ...
    should_StarBurst_destroy = false,
    old_ticks = {
...
local features = {}; do
    ...
    features.get_text = function(original_text)
        local args = {
            ...
            ["target_name"] = locals.target_aim.is_targetting and locals.target_aim.target.Name or "Not Targeting"
        };
...
do
    ...
    do
        ...
        instances["local_text"] = utility.instance_new("TextLabel", { 
            Name = "StarBurst",
            Parent = screen_gui_2,
            Text = '<font color="rgb(50, 205, 50)">S</font><font color="rgb(0, 128, 0)">t</font><font color="rgb(0, 0, 255)">a</font><font color="rgb(0, 0, 139)">r</font><font color="rgb(255, 0, 255)">B</font><font color="rgb(255, 192, 203)">u</font><font color="rgb(255, 99, 71)">r</font><font color="rgb(255, 0, 0)">s</font><font color="rgb(255, 165, 0)">t</font>',
    ...
    do
        ...
        do
            ...
            utility.new_connection(run_service.Heartbeat, function()
                ...
                if (enabled) then
                    ...
                    local text          = custom_text_enabled and '<font color="' .. text_color .. '">' .. features.get_text(custom_text) .. '</font>' or '<font color="' .. text_color .. '">StarBurst</font>';
        ...
        do
            ...
            utility.new_connection(run_service.Heartbeat, function()
                ...
                --// StarBursts classics
                local classics_enabled = flags["anti_aim_StarBurst_classics_enabled"];
                local classics_keybind = flags["anti_aim_StarBurst_classics_keybind"];
                local classics_types = flags["anti_aim_StarBurst_classics"];
                ...
                if ((enabled or classics_enabled) and (keybind or classics_keybind) and (not (classics_keybind and classics_enabled and classics_types == "supercoolboi34 Destroyer") or (classics_keybind and classics_enabled and classics_types == "supercoolboi34 Destroyer"))) then
                    ...
                    local types = {
                        ...
                        ["supercoolboi34 Destroyer"] = locals.should_StarBurst_destroy and hrp.CFrame + Vector3.new(0 / 0, 1, math.huge) or hrp.CFrame
                    };
            ...
            task.spawn(function()
                while task.wait(0.1) do
                    locals.should_StarBurst_destroy = not locals.should_StarBurst_destroy;
                end;
            end);
...
do
    if (hookmetamethod) then
        ...
        local __index; __index = hookmetamethod(game, "__index", LPH_NO_VIRTUALIZE(function(self, property)
            if (not checkcaller() and ((((flags["anti_aim_c_sync_enabled"] or (flags["anti_aim_StarBurst_classics_enabled"] and (flags["anti_aim_StarBurst_classics"] == "Destroy Cheaters" or flags["anti_aim_StarBurst_classics"] == "supercoolboi34 Destroyer"))) and (flags["anti_aim_c_sync_keybind"] or flags["anti_aim_StarBurst_classics_keybind"]))) and property == "CFrame" and self == local_player.Character.HumanoidRootPart)) then
...
do
    ...
    window:Seperator({Name = "StarBurst Premium"});
    ...
    do
        ...
        local StarBurst_classics = ui.tabs["anti_aim"]:Section({Name = "StarBurst Classics", Side = "Left", Size = 150});
        ...
        --// destroy cheaters
        do
            StarBurst_classics:Toggle({Name = "Enabled", Flag = "anti_aim_StarBurst_classics_enabled"});
            StarBurst_classics:Keybind({Flag = "anti_aim_StarBurst_classics_keybind", Name = "Keybind", Default = Enum.KeyCode.Y, Mode = "Toggle"});
            StarBurst_classics:List({Name = "Classics", Flag = "anti_aim_StarBurst_classics", Options = {"Destroy Cheaters", "supercoolboi34 Destroyer"}, Default = "Destroy Cheaters"});
        end;
    end;
    ...
    do --// credits to finobe wtv im way too lazy
        ...
        if not isfolder("StarBurst/configs") then 
            makefolder("StarBurst/configs");
        end;

        local function update_config_list()
            local list = {};
        
            for idx, file in listfiles("StarBurst/configs") do
                local file_name = file:gsub("StarBurst/configs\\", ""):gsub(".cfg", ""):gsub("StarBurst/configs/", "");
        ...
        cfgs:Button({Name = "Create", Callback = function()
            ...
            if config_name == "" or isfile("StarBurst/configs/" .. config_name .. ".cfg") then
                return;
            end;
            writefile("StarBurst/configs/" .. config_name .. ".cfg", Library:GetConfig());
            update_config_list();
        end});
        ...
        cfgs:Button({Name = "Save", Callback = function()
            ...
            if selected_config then
                writefile("StarBurst/configs/" .. selected_config .. ".cfg", Library:GetConfig());
            end;
        end});
        ...
        cfgs:Button({Name = "Load", Callback = function()
            local selected_config = flags.setting_configuration_list;
            if selected_config then
                Library:LoadConfig(readfile("StarBurst/configs/" .. selected_config .. ".cfg"));
            end;
        end});
        ...
        cfgs:Button({Name = "Delete", Callback = function()
            local selected_config = flags.setting_configuration_list;
            if selected_config then
                delfile("StarBurst/configs/" .. selected_config .. ".cfg");
            end;
            update_config_list();
        end});
